...
export class QuestionGenerateComponent implements OnInit {
  ...
  activeQuestions: Question[] = [
    {qNum: 0, code: this.qNum, text: '', type: '', resultId: 0},
    {qNum: 1, code: this.qNum, text: '', type: '', resultId: 0},
    {qNum: 2, code: this.qNum, text: '', type: '', resultId: 0},
    {qNum: 3, code: this.qNum, text: '', type: '', resultId: 0},
    {qNum: 4, code: this.qNum, text: '', type: '', resultId: 0},
    {qNum: 5, code: this.qNum, text: '', type: '', resultId: 0}
  ];
  ...
  generateButtons(qId: number): void {
    ...
    for (let i = 0; i < 6; i++) {
      this.activeQuestions[i] = {qNum: i, code: this.qNum, text: '', type: '', resultId: 0};
    }
    ...
    this.php.getQuestions(this.qNum).subscribe(
      (data) => {
